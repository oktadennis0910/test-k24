<div class="row justify-content-center mt-5">
    <div class="col-md-5">
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open_multipart($url, 'class="form"'); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="role" name="role"  required>
                            <option value="0" <?php if ($role ==="0"): ?> selected <?php endif; ?>>Member</option>
                            <option value="1" <?php if ($role ==="1"): ?> selected <?php endif; ?>>Admin</option>
                        </select>
                    </div>
